...
public class Spline {
    ...
    private void calculateCubicPolynomials() {
        ...
        for (int i = 0; i < K; ++i) {
            ...
            System.out.println(aCoefficient+","+bCoefficient+","+cCoefficient+","+dCoefficient);
     ...
     */
    public static ArrayList<Point2D.Double> getSplinePointsCenters(List<SplinePoint> splinePointList) {
        //按x轴坐标从小到大排序
        Collections.sort(splinePointList, new Comparator<SplinePoint>() {
        ...
        for (SplinePoint splinePoint : splinePointList) {
